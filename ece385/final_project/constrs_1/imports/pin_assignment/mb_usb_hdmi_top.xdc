...
set_property PACKAGE_PIN B13 [get_ports leftsound]
set_property PACKAGE_PIN B14 [get_ports rightsound]
set_property IOSTANDARD LVCMOS33 [get_ports rightsound]
set_property IOSTANDARD LVCMOS33 [get_ports leftsound]



set_property DRIVE 12 [get_ports leftsound]
set_property DRIVE 12 [get_ports rightsound]
set_property SLEW SLOW [get_ports leftsound]
set_property SLEW SLOW [get_ports rightsound]
