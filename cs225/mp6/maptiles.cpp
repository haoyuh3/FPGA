                       ...
                       vector<TileImage>& theTiles)
{
     ...
     */
    //at first don know the get match at idx is related to this construction
    // use tileImage* hash  later I find I can use int as map   but I suppose they are the same so I 
    //didnot change
    vector<Point<3>> points;
    //map<point<3>,int>  hash
    //use tileimage* as map
